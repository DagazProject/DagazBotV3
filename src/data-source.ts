...
export async function inBlackList(chatId: number): Promise<boolean> {
  try {
    const x = await db.manager.query(`
      select count(*) cnt
      from   black_list a
